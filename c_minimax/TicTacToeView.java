...
public class TicTacToeView implements InterfaceView{
    ...
    private String getResource(String resourceName) {
        return getClass().getResource("").toExternalForm()+resourceName;
...
class SquareSkin extends StackPane {
    static final Image noughtImage = new Image(
            ...
            SquareSkin.class.getResource("").toExternalForm()+"/green-cd-icon.png"
            );
    static final Image crossImage = new Image(
            ...
            SquareSkin.class.getResource("").toExternalForm()+"/blue-cross-icon.png"
            );
